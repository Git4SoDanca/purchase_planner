...
def manual_run():
	...
	conn = None
    try:
        dsn = ("dbname='{0}' host='{1}' user='{2}' password='{3}'").format(dbname, db_server_address, login, passwd) # HB, 2018-05-16, single quotes around parameters were missing
    ...
    try:
        drop_results_table(conn,companycode) # HB, 2018-05-16, this statement needed to be in a separate try block, companycode was missing in the function call
    except Exception as e:
        log_str = "I am unable to drop results table\n\n" + str(e)
        print(logfilename,log_str)
        log_entry(logfilename,log_str)
